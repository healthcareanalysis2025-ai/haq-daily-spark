    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-9 w-9 bg-muted/50 p-0 hover:bg-muted hover:text-foreground transition-colors",
        ),
        nav_button_previous: "absolute left-1",
        nav_button_next: "absolute right-1",
        table: "w-full border-collapse space-y-1 mt-2",
        head_row: "flex gap-1",
        head_cell: "text-muted-foreground rounded-md w-12 font-medium text-sm uppercase tracking-wide",
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-12 w-12 p-0 font-semibold text-base aria-selected:opacity-100 rounded-lg transition-all hover:bg-muted"),
        day_range_end: "day-range-end",
        day_selected:
          "bg-primary text-primary-foreground hover:bg-primary-hover hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground shadow-sm",
        day_today: "bg-primary/10 text-primary font-bold ring-2 ring-primary/20",
        day_outside:
